...
void loop() 
{
  ...
  if(command == "start" || command == "stop" || command == "Start" || command == "Stop")
  {
  ...
  if (command == "Right" || command == "right")
  {
   ...
   if (command == "Forward right" || command == "forward right")
  {
    theta = 135 * M_PI / 180;
  }
  if (command == "Forward left" || command == "forward right")
  {
    theta = 45 * M_PI / 180;
  }
  if (command == "Backward right" || command == "backward right")
  {
    theta = 225 * M_PI / 180;
  }
  if (command == "Backward left" || command == "backward left")
  {
    theta = 315 * M_PI / 180;
  }
  ...
  //
  if(command == "servo"|| command == "Servo")
  {
   myservo.write(0);
   delay(500);
   myservo.write(180);
